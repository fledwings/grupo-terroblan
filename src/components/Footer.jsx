      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:4426767696" className="hover:text-orange-400 transition-colors">442-676-7696</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-orange-500" />
                <a href="mailto:arturo.trejo@grupoter.com.mx" className="hover:text-orange-400 transition-colors">arturo.trejo@grupoter.com.mx</a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><button onClick={() => scrollTo('about')} className="hover:text-orange-400 transition-colors">Nosotros</button></li>
              <li><button onClick={() => scrollTo('solutions')} className="hover:text-orange-400 transition-colors">Soluciones</button></li>
              <li><button onClick={() => scrollTo('locations')} className="hover:text-orange-400 transition-colors">Ubicaciones</button></li>
              <li><button onClick={() => scrollTo('contact')} className="hover:text-orange-400 transition-colors">Contacto</button></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-900 text-sm text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-slate-500">
            <Dialog>
              <DialogTrigger asChild>
                <button className="hover:text-orange-400 transition-colors">Políticas de Privacidad</button>
              </DialogTrigger>
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-slate-900 border-slate-800 text-slate-300">
                <DialogHeader>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <button className="hover:text-orange-400 transition-colors">Condiciones de Uso</button>
              </DialogTrigger>
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-slate-900 border-slate-800 text-slate-300">
                <DialogHeader>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <button className="hover:text-orange-400 transition-colors">Términos y Condiciones</button>
              </DialogTrigger>
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-slate-900 border-slate-800 text-slate-300">
                <DialogHeader>
